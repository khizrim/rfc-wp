  ...
  <div class="footer__container">
    <div class="footer__social mobile-menu__social">
      ...
      <div class="mobile-menu__social-icons">
        <a href="<?php echo esc_url($vk); ?>" class="mobile-menu__social-icon mobile-menu__social-icon--vk" target="_blank" rel="noopener noreferrer" aria-label="ВКонтакте">
        ...
        <a href="<?php echo esc_url($telegram); ?>" class="mobile-menu__social-icon mobile-menu__social-icon--telegram" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 29 29">
