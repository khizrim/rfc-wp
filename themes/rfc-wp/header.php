...
$telegram_chat = get_field('telegram_chat_link', 'option');
$age = get_field('age_limit', 'option') ? get_field('age_limit', 'option') : '12';

$whatsapp_raw   = get_field('whatsapp_number', 'option');
$whatsapp       = $whatsapp_raw ? $whatsapp_raw : $phone;  // fallback
    ...
    <div class="header__right">
      ...
      <div class="header__contact">
        <div class="header__social">
          ...
          <?php endif; ?>
          <a href="<?php echo esc_url( $wa_link ); ?>" class="header__social-icon header__social-icon--whatsapp" target="_blank" aria-label="WhatsApp">
            <svg width="48" height="48" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
